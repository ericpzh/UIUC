...
// gets a point at a given index in the vector, used for grading.
template <int Dim>
Point<Dim> KDTree<Dim>::getPoint(unsigned index) const {
...
{
    tree.printTree(out, colored_out::enable_t::COUT, -1);
    return out;
}
