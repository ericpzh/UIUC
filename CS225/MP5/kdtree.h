...
class KDTree
{
  public:
     ...
     */
    //void quicksort(int lo , int hi, int d);
    //int partition(int a, int b, int pivotIndex, int d);
    //void select(int a, int b, int k, int d);
    //int partition1(int lo,int hi,int d);
  ...
  private:
     ...
     */
     ...
     Point<Dim> select(int a, int b, int k,int d);
     /** Helper function for Constructor */
     int partition(int a, int b, int pivotIndex, int d);
     /** Helper function for Constructor */
     void quicksort(int a, int b, int d);
     /** Helper function for findNearestNeighbor */
     Point<Dim> findNearestNeighbor(const Point<Dim>& query ,int a , int b, int d) const;
     /** Helper function for findNearestNeighbor */
     double radius(const Point<Dim>& a, const Point<Dim>& b) const;
};
