...
class MosaicCanvas
{
  public:
     ...
     */
    void setImage(unsigned size, vector<TileImage> const&tile);
    void resizeImage(int pixelsPerTile);
    void setTile(int row, int column, unsigned i);
    /**
...
{
    return myImages[myIndex[row * columns + col]];
}
